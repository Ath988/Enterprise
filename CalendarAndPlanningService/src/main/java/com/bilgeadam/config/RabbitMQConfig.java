...
//RabbitMQ kullanımı CalendarService'in daha esnek, ölçeklenebilir ve güvenilir çalışmasını sağlayarak, dağıtık sistemler arasında etkili bir mesajlaşma altyapısı sunar.
